...
import 'salon_royal_detail_screen.dart';

class SalonTypeScreen extends StatelessWidget {
  const SalonTypeScreen({super.key});
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const SalonRoyalDetailScreen(),
                              ),
                            );
                          },
                          child: Row(
