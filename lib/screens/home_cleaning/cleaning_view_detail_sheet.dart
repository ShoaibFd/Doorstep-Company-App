...
class CleaningDetailSheet extends StatefulWidget {
  const CleaningDetailSheet({super.key});

  @override
  _CleaningDetailSheetState createState() => _CleaningDetailSheetState();
}

class _CleaningDetailSheetState extends State<CleaningDetailSheet> {
  int itemCount = 0;
...
void showCleaningDetailSheet(BuildContext context) {
  showModalBottomSheet(
    ...
    builder: (context) => const CleaningDetailSheet(),
  );
}
