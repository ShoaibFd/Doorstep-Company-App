...
import '../salon_for_women/widgets/spa_view_detail_sheet.dart';

class BathCleaningDetailBottomSheetScreen extends StatefulWidget {
  const BathCleaningDetailBottomSheetScreen({super.key});

  @override
  State<BathCleaningDetailBottomSheetScreen> createState() => _BathCleaningDetailBottomSheetScreenState();
}

class _BathCleaningDetailBottomSheetScreenState extends State<BathCleaningDetailBottomSheetScreen> {
  List<String> images1 = [
