...
import 'spa_for_women_detail_screen.dart';

class SpaForWomenScreen extends StatelessWidget {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const SpaForWomenDetailScreen()));
              },
